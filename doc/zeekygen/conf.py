...
sys.path.insert(0, os.path.abspath('../zeek-docs/ext'))
...
templates_path = ['zeek-docs/_templates']
...
project = u'Zeek Exporter'
copyright = u'2019, LBNL'
...
html_title = u'Zeek Prometheus Exporter Plugin ' + release
...
html_static_path = ['../zeek-docs/_static']
